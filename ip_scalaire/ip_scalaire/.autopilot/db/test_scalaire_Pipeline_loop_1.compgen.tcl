...
set name test_scalaire_fadd_32ns_32ns_32_10_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 9 ALLOW_PRAGMA 1
}


set name test_scalaire_fmul_32ns_32ns_32_7_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename tmp1 \
    op interface \
    ports { tmp1_address0 { O 4 vector } tmp1_ce0 { O 1 bit } tmp1_we0 { O 1 bit } tmp1_d0 { O 32 vector } tmp1_address1 { O 4 vector } tmp1_ce1 { O 1 bit } tmp1_q1 { I 32 vector } } \
} "
} else {
