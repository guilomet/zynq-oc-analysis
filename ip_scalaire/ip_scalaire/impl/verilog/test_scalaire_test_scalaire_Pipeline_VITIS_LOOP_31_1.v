...
module test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_31_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln31_reg_138;
reg   [31:0] empty_23_reg_152;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [31:0] zext_ln33_fu_107_p1;
wire    ap_block_pp0_stage0_01001;
reg   [4:0] j_fu_48;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_j_1;
wire   [4:0] add_ln31_fu_97_p2;
wire   [3:0] trunc_ln33_fu_103_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln31_fu_91_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln31_reg_138 == 1'd0))) begin
        empty_23_reg_152 <= tmp1_q0;
    end
end

always @ (*) begin
    if (((icmp_ln31_fu_91_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln31_reg_138 == 1'd1))) begin
...
assign add_ln31_fu_97_p2 = (ap_sig_allocacmp_j_1 + 5'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_bus_res_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_bus_res_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign icmp_ln31_fu_91_p2 = ((ap_sig_allocacmp_j_1 == 5'd16) ? 1'b1 : 1'b0);
...
assign m_axi_bus_res_WDATA = empty_23_reg_152;
...
assign tmp1_address0 = zext_ln33_fu_107_p1;

assign trunc_ln33_fu_103_p1 = ap_sig_allocacmp_j_1[3:0];

assign zext_ln33_fu_107_p1 = trunc_ln33_fu_103_p1;

endmodule //test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_31_1
