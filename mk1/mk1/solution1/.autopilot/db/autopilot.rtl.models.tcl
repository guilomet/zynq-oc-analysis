set SynModuleInfo {
  {SRCNAME test_scalaire_Pipeline_VITIS_LOOP_14_1 MODELNAME test_scalaire_Pipeline_VITIS_LOOP_14_1 RTLNAME test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_14_1
    SUBMODULES {
      {MODELNAME test_scalaire_fadd_32ns_32ns_32_5_full_dsp_1 RTLNAME test_scalaire_fadd_32ns_32ns_32_5_full_dsp_1 BINDTYPE op TYPE fadd IMPL fulldsp LATENCY 4 ALLOW_PRAGMA 1}
      {MODELNAME test_scalaire_fmul_32ns_32ns_32_4_max_dsp_1 RTLNAME test_scalaire_fmul_32ns_32ns_32_4_max_dsp_1 BINDTYPE op TYPE fmul IMPL maxdsp LATENCY 3 ALLOW_PRAGMA 1}
