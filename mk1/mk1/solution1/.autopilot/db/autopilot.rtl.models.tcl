set SynModuleInfo {
  {SRCNAME test_scalaire_Pipeline_main_loop MODELNAME test_scalaire_Pipeline_main_loop RTLNAME test_scalaire_test_scalaire_Pipeline_main_loop
    SUBMODULES {
  ...
  {SRCNAME test_scalaire_Pipeline_VITIS_LOOP_21_1 MODELNAME test_scalaire_Pipeline_VITIS_LOOP_21_1 RTLNAME test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_21_1}
