...
module test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_11_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln11_reg_196_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln11_reg_196 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln11_reg_196 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln11_reg_196_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    if (((icmp_ln11_reg_196 == 1'd0) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln11_reg_196 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln11_reg_196_pp0_iter1_reg == 1'd1))) begin
        tmp_out_ap_vld = 1'b1;
    end else begin
        tmp_out_ap_vld = 1'b0;
    end
...
always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((m_axi_bus_B_RVALID == 1'b0) & (icmp_ln11_reg_196 == 1'd0)) | ((icmp_ln11_reg_196 == 1'd0) & (m_axi_bus_A_RVALID == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((m_axi_bus_B_RVALID == 1'b0) & (icmp_ln11_reg_196 == 1'd0)) | ((icmp_ln11_reg_196 == 1'd0) & (m_axi_bus_A_RVALID == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((m_axi_bus_B_RVALID == 1'b0) & (icmp_ln11_reg_196 == 1'd0)) | ((icmp_ln11_reg_196 == 1'd0) & (m_axi_bus_A_RVALID == 1'b0))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = (((m_axi_bus_B_RVALID == 1'b0) & (icmp_ln11_reg_196 == 1'd0)) | ((icmp_ln11_reg_196 == 1'd0) & (m_axi_bus_A_RVALID == 1'b0)));
end
...
assign icmp_ln11_fu_122_p2 = ((ap_sig_allocacmp_i_V_1 == 9'd256) ? 1'b1 : 1'b0);
...
assign tmp_out = tmp_fu_60;

endmodule //test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_11_1
