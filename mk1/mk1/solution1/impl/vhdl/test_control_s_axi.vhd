...
port (
    ...
    B_ce0                 :in   STD_LOGIC;
    B_we0                 :in   STD_LOGIC;
    B_d0                  :in   STD_LOGIC_VECTOR(31 downto 0)
);
...
architecture behave of test_control_s_axi is
    ...
    constant ADDR_A_BASE      : INTEGER := 16#400#;
    constant ADDR_A_HIGH      : INTEGER := 16#7ff#;
    constant ADDR_B_BASE      : INTEGER := 16#800#;
    constant ADDR_B_HIGH      : INTEGER := 16#bff#;
    ...
    component test_control_s_axi_ram is
        generic (
    ...
    end component test_control_s_axi_ram;
...
entity test_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity test_control_s_axi_ram;

architecture behave of test_control_s_axi_ram is
