...
entity test_scalaire_bus_res_s_axi is
generic (
...
end entity test_scalaire_bus_res_s_axi;
...
-- 0x24 : Control signal of res
--        bit 0  - res_ap_vld (Read/COR)
--        others - reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of test_scalaire_bus_res_s_axi is
    ...
    constant ADDR_RES_DATA_0 : INTEGER := 16#20#;
    constant ADDR_RES_CTRL   : INTEGER := 16#24#;
