...
entity test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_17_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln17_1 : IN STD_LOGIC_VECTOR (29 downto 0);
    sext_ln17 : IN STD_LOGIC_VECTOR (29 downto 0);
...
architecture behav of test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_17_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln17_reg_174 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_V_1_reg_169 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_V_1_reg_169_pp0_iter1_reg : STD_LOGIC_VECTOR (8 downto 0);
    signal i_V_1_reg_169_pp0_iter2_reg : STD_LOGIC_VECTOR (8 downto 0);
    signal i_V_1_reg_169_pp0_iter3_reg : STD_LOGIC_VECTOR (8 downto 0);
    signal i_V_1_reg_169_pp0_iter4_reg : STD_LOGIC_VECTOR (8 downto 0);
    signal i_V_1_reg_169_pp0_iter5_reg : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal mul_reg_198 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal zext_ln24_fu_148_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_V_fu_52 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_V_1 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_V_2_fu_117_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    fmul_32ns_32ns_32_4_max_dsp_1_U1 : component test_scalaire_fmul_32ns_32ns_32_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln17_reg_174 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_bus_A_RVALID, icmp_ln17_reg_174, m_axi_bus_B_RVALID)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((icmp_ln17_reg_174 = ap_const_lv1_0) and (m_axi_bus_A_RVALID = ap_const_logic_0)) or ((icmp_ln17_reg_174 = ap_const_lv1_0) and (m_axi_bus_B_RVALID = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_bus_A_RVALID, icmp_ln17_reg_174, m_axi_bus_B_RVALID)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((icmp_ln17_reg_174 = ap_const_lv1_0) and (m_axi_bus_A_RVALID = ap_const_logic_0)) or ((icmp_ln17_reg_174 = ap_const_lv1_0) and (m_axi_bus_B_RVALID = ap_const_logic_0))));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_bus_A_RVALID, icmp_ln17_reg_174, m_axi_bus_B_RVALID)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((icmp_ln17_reg_174 = ap_const_lv1_0) and (m_axi_bus_A_RVALID = ap_const_logic_0)) or ((icmp_ln17_reg_174 = ap_const_lv1_0) and (m_axi_bus_B_RVALID = ap_const_logic_0)));
    end process;
    ...
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln17_fu_111_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln17_reg_174, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln17_reg_174 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_i_V_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_V_fu_52, ap_loop_init)
    begin
    ...
    bus_A_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_bus_A_RVALID, icmp_ln17_reg_174, ap_block_pp0_stage0)
    begin
        if (((icmp_ln17_reg_174 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    bus_B_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln17_reg_174, m_axi_bus_B_RVALID, ap_block_pp0_stage0)
    begin
        if (((icmp_ln17_reg_174 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    grp_fu_91_p0 <= bus_A_addr_read_reg_178;
    grp_fu_91_p1 <= bus_B_addr_read_reg_183;
    i_V_2_fu_117_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V_1) + unsigned(ap_const_lv9_1));
    icmp_ln17_fu_111_p2 <= "1" when (ap_sig_allocacmp_i_V_1 = ap_const_lv9_100) else "0";
    ...
    m_axi_bus_A_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln17_reg_174, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln17_reg_174 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_axi_bus_B_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln17_reg_174, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln17_reg_174 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    tmp_address0 <= zext_ln24_fu_148_p1(8 - 1 downto 0);

    tmp_ce0_assign_proc : process(ap_enable_reg_pp0_iter6, ap_block_pp0_stage0_11001)
    begin
    ...
    tmp_we0_assign_proc : process(ap_enable_reg_pp0_iter6, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter6 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    zext_ln24_fu_148_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_V_1_reg_169_pp0_iter5_reg),32));
end behav;
