...
entity test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_19_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln19_1 : IN STD_LOGIC_VECTOR (29 downto 0);
    ...
    sext_ln19 : IN STD_LOGIC_VECTOR (29 downto 0);
    tmp2_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    tmp2_out_ap_vld : OUT STD_LOGIC );
end;


architecture behav of test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_19_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln19_reg_196 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln19_reg_196_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp2_1_reg_230 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage1_subdone : BOOLEAN;
    signal i_V_fu_56 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_V_1 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_V_2_fu_128_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp2_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => ap_sig_allocacmp_tmp2_load,
        din1 => tmp_reg_220,
        ce => grp_fu_93_ce,
        dout => grp_fu_93_p2);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln19_fu_122_p2 = ap_const_lv1_0))) then 
                    i_V_fu_56 <= i_V_2_fu_128_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_V_fu_56 <= ap_const_lv9_0;
                end if;
            end if; 
        end if;
    end process;

    tmp2_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                tmp2_fu_60 <= ap_const_lv32_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln19_reg_196 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln19_reg_196 <= icmp_ln19_fu_122_p2;
                icmp_ln19_reg_196_pp0_iter1_reg <= icmp_ln19_reg_196;
                tmp2_1_reg_230 <= grp_fu_93_p2;
                tmp_reg_220 <= grp_fu_97_p2;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage1_01001_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln19_reg_196, m_axi_bus_B_RVALID, m_axi_bus_A_RVALID)
    begin
                ap_block_pp0_stage1_01001 <= ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (((m_axi_bus_B_RVALID = ap_const_logic_0) and (icmp_ln19_reg_196 = ap_const_lv1_0)) or ((icmp_ln19_reg_196 = ap_const_lv1_0) and (m_axi_bus_A_RVALID = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage1_11001_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln19_reg_196, m_axi_bus_B_RVALID, m_axi_bus_A_RVALID)
    begin
                ap_block_pp0_stage1_11001 <= ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (((m_axi_bus_B_RVALID = ap_const_logic_0) and (icmp_ln19_reg_196 = ap_const_lv1_0)) or ((icmp_ln19_reg_196 = ap_const_lv1_0) and (m_axi_bus_A_RVALID = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage1_subdone_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln19_reg_196, m_axi_bus_B_RVALID, m_axi_bus_A_RVALID)
    begin
                ap_block_pp0_stage1_subdone <= ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (((m_axi_bus_B_RVALID = ap_const_logic_0) and (icmp_ln19_reg_196 = ap_const_lv1_0)) or ((icmp_ln19_reg_196 = ap_const_lv1_0) and (m_axi_bus_A_RVALID = ap_const_logic_0))));
    end process;
    ...
    ap_block_state2_pp0_stage1_iter0_assign_proc : process(icmp_ln19_reg_196, m_axi_bus_B_RVALID, m_axi_bus_A_RVALID)
    begin
                ap_block_state2_pp0_stage1_iter0 <= (((m_axi_bus_B_RVALID = ap_const_logic_0) and (icmp_ln19_reg_196 = ap_const_lv1_0)) or ((icmp_ln19_reg_196 = ap_const_lv1_0) and (m_axi_bus_A_RVALID = ap_const_logic_0)));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage4_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage4, ap_block_pp0_stage4_subdone, icmp_ln19_reg_196)
    begin
        if (((icmp_ln19_reg_196 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage4_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4))) then 
    ...
    ap_condition_exit_pp0_iter1_stage1_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, icmp_ln19_reg_196_pp0_iter1_reg, ap_block_pp0_stage1_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln19_reg_196_pp0_iter1_reg = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_i_V_1_assign_proc : process(ap_CS_fsm_pp0_stage0, i_V_fu_56, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    ap_sig_allocacmp_tmp2_load_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, tmp2_1_reg_230, tmp2_fu_60)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            ap_sig_allocacmp_tmp2_load <= tmp2_1_reg_230;
        else 
            ap_sig_allocacmp_tmp2_load <= tmp2_fu_60;
        end if; 
    end process;


    bus_A_blk_n_R_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln19_reg_196, m_axi_bus_A_RVALID, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1)
    begin
        if (((icmp_ln19_reg_196 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    bus_B_blk_n_R_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln19_reg_196, m_axi_bus_B_RVALID, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1)
    begin
        if (((icmp_ln19_reg_196 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    grp_fu_93_ce_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage4, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0_11001, ap_block_pp0_stage1_11001, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_11001, ap_block_pp0_stage3_11001, ap_block_pp0_stage4_11001, ap_CS_fsm_pp0_stage3)
    begin
    ...
    grp_fu_97_ce_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage4, ap_block_pp0_stage0_11001, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_11001, ap_block_pp0_stage3_11001, ap_block_pp0_stage4_11001, ap_CS_fsm_pp0_stage3)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage4_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4)) or ((ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3)) or ((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    i_V_2_fu_128_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V_1) + unsigned(ap_const_lv9_1));
    icmp_ln19_fu_122_p2 <= "1" when (ap_sig_allocacmp_i_V_1 = ap_const_lv9_100) else "0";
    ...
    m_axi_bus_A_RREADY_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln19_reg_196, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln19_reg_196 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    m_axi_bus_B_RREADY_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln19_reg_196, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln19_reg_196 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    tmp2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln19_reg_196_pp0_iter1_reg, ap_block_pp0_stage1_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln19_reg_196_pp0_iter1_reg = ap_const_lv1_1))) then 
            tmp2_out_ap_vld <= ap_const_logic_1;
        else 
            tmp2_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
