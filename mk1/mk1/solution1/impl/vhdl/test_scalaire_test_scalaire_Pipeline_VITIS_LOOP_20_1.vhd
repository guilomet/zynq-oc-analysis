...
entity test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_20_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln20_1 : IN STD_LOGIC_VECTOR (29 downto 0);
    ...
    sext_ln20 : IN STD_LOGIC_VECTOR (29 downto 0);
    add39_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    add39_out_ap_vld : OUT STD_LOGIC;
    tmp_1_out : OUT STD_LOGIC_VECTOR (31 downto 0);
...
architecture behav of test_scalaire_test_scalaire_Pipeline_VITIS_LOOP_20_1 is 
...
attribute shreg_extract : string;
    ...
    signal bus_A_addr_read_reg_270 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state3_pp0_stage2_iter0 : BOOLEAN;
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal bus_B_addr_read_reg_275 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmpA_fu_189_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage3 : signal is "none";
    signal ap_block_state4_pp0_stage3_iter0 : BOOLEAN;
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal tmpB_fu_193_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_reg_290 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage5_11001 : BOOLEAN;
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal i_V_fu_60 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_V_2_fu_170_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal tmp_1_fu_64 : STD_LOGIC_VECTOR (31 downto 0);
    signal add39_fu_68 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    add39_fu_68_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    add39_fu_68 <= bitcast_ln23;
                elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                    add39_fu_68 <= add_reg_290;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                i_V_fu_60 <= ap_const_lv8_0;
            elsif (((icmp_ln1057_fu_164_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                i_V_fu_60 <= i_V_2_fu_170_p2;
            end if; 
        end if;
    end process;

    tmp_1_fu_64_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    tmp_1_fu_64 <= grp_fu_184_p_dout0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then
                add_reg_290 <= grp_fu_180_p_dout0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
                bus_A_addr_read_reg_270 <= m_axi_bus_A_RDATA;
                bus_B_addr_read_reg_275 <= m_axi_bus_B_RDATA;
            end if;
        end if;
    end process;
    ...
    add39_out <= add39_fu_68;

    add39_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln1057_fu_164_p2, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln1057_fu_164_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            add39_out_ap_vld <= ap_const_logic_1;
        else 
            add39_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    ap_block_pp0_stage2_11001_assign_proc : process(ap_enable_reg_pp0_iter0, m_axi_bus_B_RVALID, m_axi_bus_A_RVALID)
    begin
                ap_block_pp0_stage2_11001 <= ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and ((m_axi_bus_A_RVALID = ap_const_logic_0) or (m_axi_bus_B_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage2_subdone_assign_proc : process(ap_enable_reg_pp0_iter0, m_axi_bus_B_RVALID, m_axi_bus_A_RVALID)
    begin
                ap_block_pp0_stage2_subdone <= ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and ((m_axi_bus_A_RVALID = ap_const_logic_0) or (m_axi_bus_B_RVALID = ap_const_logic_0)));
    end process;
    ...
    ap_block_state3_pp0_stage2_iter0_assign_proc : process(m_axi_bus_B_RVALID, m_axi_bus_A_RVALID)
    begin
                ap_block_state3_pp0_stage2_iter0 <= ((m_axi_bus_A_RVALID = ap_const_logic_0) or (m_axi_bus_B_RVALID = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, icmp_ln1057_fu_164_p2)
    begin
        if (((icmp_ln1057_fu_164_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    bus_A_blk_n_R_assign_proc : process(ap_enable_reg_pp0_iter0, m_axi_bus_A_RVALID, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
    ...
    bus_B_blk_n_R_assign_proc : process(ap_enable_reg_pp0_iter0, m_axi_bus_B_RVALID, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    grp_fu_120_ce_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage5, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage1_11001, ap_block_pp0_stage2_11001, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_11001, ap_block_pp0_stage5_11001, ap_block_pp0_stage4_11001, ap_CS_fsm_pp0_stage4)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage4_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4)) or ((ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5)) or ((ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3)) or ((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2)) or ((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1)))) then 
    ...
    grp_fu_124_ce_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage5, ap_block_pp0_stage0_11001, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_11001, ap_block_pp0_stage5_11001, ap_block_pp0_stage4_11001, ap_CS_fsm_pp0_stage4)
    begin
    ...
    grp_fu_180_p_ce <= grp_fu_120_ce;
    grp_fu_180_p_din0 <= add39_fu_68;
    grp_fu_180_p_din1 <= tmp_1_fu_64;
    grp_fu_180_p_opcode <= ap_const_lv2_0;
    grp_fu_184_p_ce <= grp_fu_124_ce;
    grp_fu_184_p_din0 <= tmpA_fu_189_p1;
    grp_fu_184_p_din1 <= tmpB_fu_193_p1;
    i_V_2_fu_170_p2 <= std_logic_vector(unsigned(i_V_fu_60) + unsigned(ap_const_lv8_1));
    icmp_ln1057_fu_164_p2 <= "1" when (i_V_fu_60 = ap_const_lv8_FF) else "0";
    ...
    m_axi_bus_A_RREADY_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_11001)
    begin
    ...
    m_axi_bus_B_RREADY_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    tmpA_fu_189_p1 <= bus_A_addr_read_reg_270;
    tmpB_fu_193_p1 <= bus_B_addr_read_reg_275;
    tmp_1_out <= tmp_1_fu_64;

    tmp_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln1057_fu_164_p2, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln1057_fu_164_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
