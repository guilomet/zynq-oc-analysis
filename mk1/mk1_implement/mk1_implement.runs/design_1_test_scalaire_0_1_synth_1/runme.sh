...
HD_PWD='F:/projet_m2/mk1/mk1_implement/mk1_implement.runs/design_1_test_scalaire_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_test_scalaire_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_test_scalaire_0_1.tcl
