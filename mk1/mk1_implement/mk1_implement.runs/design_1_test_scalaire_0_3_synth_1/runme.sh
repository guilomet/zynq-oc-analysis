...
HD_PWD='F:/projet_m2/git/zynq-oc-analysis/mk1/mk1_implement/mk1_implement.runs/design_1_test_scalaire_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_test_scalaire_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_test_scalaire_0_3.tcl
